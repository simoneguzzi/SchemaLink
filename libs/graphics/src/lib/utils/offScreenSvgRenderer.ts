...
export const renderSvgEncapsulated = (
  ...
  return new Promise((resolve, reject) => {
    ...
    assembleGoogleFontFacesCssWithEmbeddedFontData(fontFamily, codePoints).then(
      (cssRules) => {
...
const createVisualGraphAndBoundingBox = (
  graph: Graph,
  cachedImages: Record<string, ImageInfo>
) => {
  const renderState = {
